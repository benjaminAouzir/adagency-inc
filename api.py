    ...
    for feature in feature_ranges.keys():
        if feature in features_to_predict:
            if feature_ranges[feature][1] == 1:
                ...
                feature_values[feature] = np.linspace(feature_ranges[feature][0], feature_ranges[feature][1],
                                                      num_samples)
...
def get_post_javascript_data():
    print(int(request.json["year"]))

    columns = [
        # Movie nurmerical features
        'Runtime', 'Release year_x',
        # Language categorical feature
        'English Language-onehot', 'Tamil Language-onehot', 'Hindi Language-onehot', 'Malayalam Language-onehot',
        'German Language-onehot', 'Japanese Language-onehot', 'Korean Language-onehot', 'Spanish Language-onehot',
        'Italian Language-onehot', 'French Language-onehot', 'Standard Mandarin-onehot', 'Standard Cantonese-onehot',
        'Bengali Language-onehot', 'Cantonese-onehot', 'Telugu language-onehot', 'Russian Language-onehot',
        'Portuguese Language-onehot', 'Urdu Language-onehot', 'Arabic Language-onehot', 'Tagalog language-onehot',
        'Swedish Language-onehot',
        # Country categorical feature
        'United States of America-onehot', 'United Kingdom-onehot', 'India-onehot', 'Canada-onehot', 'Germany-onehot',
        'Japan-onehot', 'South Korea-onehot', 'Argentina-onehot', 'France-onehot', 'Spain-onehot', 'Ireland-onehot',
        'Hong Kong-onehot', 'China-onehot', 'Russia-onehot', 'Australia-onehot', 'Italy-onehot', 'Mexico-onehot',
        'New Zealand-onehot', 'Brazil-onehot', 'Belgium-onehot', 'Denmark-onehot', 'Sweden-onehot',
        'Netherlands-onehot', 'Philippines-onehot',
        # Genre categorical feature
        'Thriller-onehot', 'Science Fiction-onehot', 'Horror-onehot', 'Adventure-onehot', 'Action-onehot',
        'Drama-onehot', 'Comedy-onehot', 'Romance Film-onehot', 'Musical-onehot', 'Fantasy-onehot',
        'Family Film-onehot', 'Crime Fiction-onehot', 'Indie-onehot', 'World cinema-onehot', 'Mystery-onehot',
        'Black-and-white-onehot', 'Crime Thriller-onehot',
        ...
        'White_x', 'Black/African American_x', 'South Asian_x', 'East Asian_x', 'American Indian/Alaska Native_x',
        'Pacific Islander_x', 'Arab/Middle East_x', 'Central and South Americans_x', 'Other_x',
        ...
        'White_y', 'Black/African American_y', 'South Asian_y', 'East Asian_y', 'American Indian/Alaska Native_y',
        'Pacific Islander_y', 'Arab/Middle East_y', 'Central and South Americans_y',
        'Other_y']  # Replace this with your list of columns
    ...
    Runtime = 110
    Release_year = int(request.json["year"])
    # Languages = ['English']
    Languages = [request.json["language"]]
    Countries = [request.json["country"], 'United Kingdom']
    Genres = ['Thriller', 'Science Fiction']
    Primary_actor_height = int(request.json["primary_height"])
    Primary_actor_age = int(request.json["primary_age"])
    Primary_actor_gender = request.json["primary_gender"]
    Primary_actor_ethnicity = request.json["primary_ethnicity"]
    ...
    data = {'achieved score': achieved_score[0]}
